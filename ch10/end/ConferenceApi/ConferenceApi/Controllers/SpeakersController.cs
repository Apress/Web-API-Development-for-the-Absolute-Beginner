...
namespace ConferenceApi.Controllers
{
    ...
    public class SpeakersController : ControllerBase
    {
        ...
        //[HttpPost("testbind")]
        //public ActionResult<MyModel> TestBindAttributes()
        //{
        //    return Ok($"{this.MyModel.FirstName}, {this.MyModel.LastName}");
        //}


        //[HttpGet]
        //public IActionResult GetAll([FromHeader(Name = "Accept")] string accept)
        //{
        ...
        //[HttpGet("{id}")]
        //public IActionResult GetbyId([ModelBinder(Name = "id")] SpeakerModel speaker)
        //{
        //    if (speaker == null)
        //    {
        //        return NotFound();
